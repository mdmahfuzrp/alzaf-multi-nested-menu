      ...
      <Slider className="relative mx-auto " ref={sliderRef} {...settings}>
        <div className=" flex flex-col gap-10 mt-[1px] ">
          <div className="flex flex-col gap-5">
            ...
            <div className="bg-white col-span-1 rounded-[4px] w-full slideOverlay flex flex-col xl:flex-row gap-2">
                <div className="relative flex flex-col items-center justify-center pt-[10px] px-[16px] pb-[20px] mx-auto">
                  <img
                    src="https://i.ibb.co/SfMBpWS/categories.png"
                    alt=""
                    className=""
                  />
                  <h1 className="text-primary">Hand Dishwashing</h1>
                </div>
              </div>
              <div className="bg-white col-span-1 rounded-[4px] w-full slideOverlay flex flex-col xl:flex-row gap-2">
                <div className="relative flex flex-col items-center justify-center pt-[10px] px-[16px] pb-[20px] mx-auto">
